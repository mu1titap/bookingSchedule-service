...
public class KafkaProducerConfig {
    ...
    // 세션 종료
    @Bean
    public ProducerFactory<String, EndSessionMessage> endSessionProducerFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaClusterUri);
        configProps.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
    ...
    @Bean
    public KafkaTemplate<String, EndSessionMessage> kafkaEndSessionTemplate() {
        return new KafkaTemplate<>(endSessionProducerFactory());
    }
